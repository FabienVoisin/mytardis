...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Organism.id'
        db.alter_column(u'acad_organism', 'id', self.gf('django.db.models.fields.PositiveIntegerField')(primary_key=True))

    def backwards(self, orm):

        # Changing field 'Organism.id'
        db.alter_column(u'acad_organism', 'id', self.gf('django.db.models.fields.PositiveSmallIntegerField')(primary_key=True))
