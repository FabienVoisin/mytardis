...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source.arch_date'
        db.add_column(u'acad_source', 'arch_date',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


        # Changing field 'Source.date'
        db.alter_column(u'acad_source', 'date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Source.arch_date'
        db.delete_column(u'acad_source', 'arch_date')


        # Changing field 'Source.date'
        db.alter_column(u'acad_source', 'date', self.gf('django.db.models.fields.DateField')(default='1901-01-01'))
