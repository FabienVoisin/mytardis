...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source.geo_depth'
        db.add_column(u'acad_source', 'geo_depth',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source.geo_altitude'
        db.add_column(u'acad_source', 'geo_altitude',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source.geo_elev'
        db.add_column(u'acad_source', 'geo_elev',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Source.carbondate_error'
        db.alter_column(u'acad_source', 'carbondate_error', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Source.carbondate_years'
        db.alter_column(u'acad_source', 'carbondate_years', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Source.geo_depth'
        db.delete_column(u'acad_source', 'geo_depth')

        # Deleting field 'Source.geo_altitude'
        db.delete_column(u'acad_source', 'geo_altitude')

        # Deleting field 'Source.geo_elev'
        db.delete_column(u'acad_source', 'geo_elev')


        # Changing field 'Source.carbondate_error'
        db.alter_column(u'acad_source', 'carbondate_error', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'Source.carbondate_years'
        db.alter_column(u'acad_source', 'carbondate_years', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
