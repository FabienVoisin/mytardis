...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Sequence', fields ['library']
        db.delete_unique(u'acad_sequence', ['library_id'])

        # Removing unique constraint on 'Processing', fields ['sequence']
        db.delete_unique(u'acad_processing', ['sequence_id'])

        # Adding field 'Processing.package'
        db.add_column(u'acad_processing', 'package',
                      self.gf('django.db.models.fields.CharField')(default='fred', max_length=255),
                      keep_default=False)

        # Adding field 'Processing.package_ver'
        db.add_column(u'acad_processing', 'package_ver',
                      self.gf('django.db.models.fields.CharField')(default='fred', max_length=255),
                      keep_default=False)


        # Changing field 'Processing.sequence'
        db.alter_column(u'acad_processing', 'sequence_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['acad.Sequence']))

        # Changing field 'Sequence.library'
        db.alter_column(u'acad_sequence', 'library_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['acad.Library']))
        # Deleting field 'Analysis.note'
        db.delete_column(u'acad_analysis', 'note')

        # Adding field 'Analysis.package'
        db.add_column(u'acad_analysis', 'package',
                      self.gf('django.db.models.fields.CharField')(default='fred', max_length=255),
                      keep_default=False)

        # Adding field 'Analysis.package_ver'
        db.add_column(u'acad_analysis', 'package_ver',
                      self.gf('django.db.models.fields.CharField')(default='fred', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Processing.package'
        db.delete_column(u'acad_processing', 'package')

        # Deleting field 'Processing.package_ver'
        db.delete_column(u'acad_processing', 'package_ver')


        # Changing field 'Processing.sequence'
        db.alter_column(u'acad_processing', 'sequence_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['acad.Sequence'], unique=True))
        # Adding unique constraint on 'Processing', fields ['sequence']
        db.create_unique(u'acad_processing', ['sequence_id'])


        # Changing field 'Sequence.library'
        db.alter_column(u'acad_sequence', 'library_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['acad.Library'], unique=True))
        # Adding unique constraint on 'Sequence', fields ['library']
        db.create_unique(u'acad_sequence', ['library_id'])

        # Adding field 'Analysis.note'
        db.add_column(u'acad_analysis', 'note',
                      self.gf('django.db.models.fields.TextField')(default='fred'),
                      keep_default=False)

        # Deleting field 'Analysis.package'
        db.delete_column(u'acad_analysis', 'package')

        # Deleting field 'Analysis.package_ver'
        db.delete_column(u'acad_analysis', 'package_ver')
