...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'tardis_portal_dataset', 'experiment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tardis_portal.Experiment'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dataset.experiment'
        db.delete_column(u'tardis_portal_dataset', 'experiment_id')
    ...
    models = {
        ...
        'tardis_portal.dataset': {
            ...
            'directory': ('tardis.tardis_portal.models.fields.DirectoryField', [], {'null': 'True', 'blank': 'True'}),
            'experiment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tardis_portal.Experiment']", 'null': 'True'}),
        ...
        'tardis_portal.token': {
            ...
            'experiment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tardis_portal.Experiment']"}),
            'expiry_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 3, 25, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
