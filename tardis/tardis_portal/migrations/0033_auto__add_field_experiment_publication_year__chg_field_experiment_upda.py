...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Experiment.publication_year'
        db.add_column(u'tardis_portal_experiment', 'publication_year',
                      self.gf('django.db.models.fields.CharField')(default=2015, max_length=4),
                      keep_default=False)


        # Changing field 'Experiment.update_time'
        db.alter_column(u'tardis_portal_experiment', 'update_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'Experiment.publication_year'
        db.delete_column(u'tardis_portal_experiment', 'publication_year')


        # Changing field 'Experiment.update_time'
        db.alter_column(u'tardis_portal_experiment', 'update_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    models = {
        ...
        'tardis_portal.token': {
            ...
            'experiment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tardis_portal.Experiment']"}),
            'expiry_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 2, 26, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
